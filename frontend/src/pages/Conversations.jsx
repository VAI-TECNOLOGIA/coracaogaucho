...
const TEMPLATES = [
  { name: 'Boas-vindas voluntário', body: 'Olá! 👋 Que bom ter você na Confia+ RS! Para confirmar sua participação como voluntário, responda *SIM*. Porque o povo fala mais alto! 💪' },
